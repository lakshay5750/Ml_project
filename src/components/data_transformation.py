...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info("Nmerical standard scaling is completed")
            logging.info("categorical one hot encoding completed")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("data is read from both training path and test path")
